...
document.head.appendChild(fa);
  ...
  const navLinks = isArabic ? [
    ...
    { label: 'الساحة السيبرانية', href: basePath + 'frontend/index.html#/' },
    { label: 'النادي السيبراني', href: basePath + 'frontend/index.html#/club' },
    { label: 'الأصدقاء', href: basePath + 'frontend/index.html#/friends' },
    { label: 'من نحن', href: '#' },
    { label: 'اتصل بنا', href: '#' },
  ] : [
    ...
    { label: 'Cyber Arena', href: basePath + 'frontend/index.html#/' },
    { label: 'Cyber Club', href: basePath + 'frontend/index.html#/club' },
    { label: 'Friends', href: basePath + 'frontend/index.html#/friends' },
    { label: 'About Us', href: '#' },
