...
document.head.appendChild(fa);
  ...
  const navLinks = isArabic ? [
    ...
    { label: 'الساحة السيبرانية', href: basePath + 'frontend/dist/index.html#/' },
    { label: 'النادي السيبراني', href: basePath + 'frontend/dist/index.html#/club' },
    { label: 'الأصدقاء', href: basePath + 'frontend/dist/index.html#/friends' },
    { label: 'من نحن', href: '#' },
    { label: 'اتصل بنا', href: '#' },
  ] : [
    ...
    { label: 'Cyber Arena', href: basePath + 'frontend/dist/index.html#/' },
    { label: 'Cyber Club', href: basePath + 'frontend/dist/index.html#/club' },
    { label: 'Friends', href: basePath + 'frontend/dist/index.html#/friends' },
    { label: 'About Us', href: '#' },
